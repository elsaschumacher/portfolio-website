    ...
    <div className="space-y-2">
      ...
      <div className="space-y-1">
        <p>
          ...
          <br />
          <span className="max-w-lg">
            Serving on the board for the association of computer science
            students at Aalto University. In charge of internal and external
            communications for the guild, including social media and email
            lists.
          </span>
        </p>
        <p>
          <span className="font-semibold text-lg">Tutor</span>
          <br />
          <span className="italic">Aalto University, 2022 & 2023</span>
          <br />
          <span className="max-w-lg">
            Helping new students get acquainted to university and student life.
            I've been a tutor for both new Bachelor's students as well as
            exchange students.
          </span>
        </p>
      </div>
